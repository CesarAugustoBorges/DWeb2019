...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:result-document href="html/index.html">
            <html>
                <head>
                    <title>Arquivo de Arquiossitios</title>
                    <meta charset="UTF-8"/>
                    <link rel="stylesheet" href="w3.css"/>  
                </head>
                <body>
                    <div class="w3-container">
                        <h1>Arquivo de Arquiossitios</h1>
                        <h3>Indice de Arquiossitios</h3>
                        <ol class="w3-list">
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li class="w3-text-indigo">
            <a name="{generate-id()}"/>
            <a href="arq-{generate-id()}.html"><xsl:value-of select="normalize-space(IDENTI)"/></a>
        </li>
    </xsl:template>
